      ...
      (response: any) => {
        ...
        if (result) {
          this.vehicleData = {
            ...
            vehicleType: result.vehicle_type ? result.vehicle_type : result.other_vehicle_type,
            vehicleMake: result.vehicle_make ? result.vehicle_make : result.other_vehicle_make,
