...
export class ClientMainAppPage implements OnInit {
  ...
  initMenu() {
    this.menuItems = [
      ...
      // { src: "assets/icon/home-icon/door.png", alt: "Icon for Door Access", text: "Door Access", route: "/client-door-access", permission: [true, true], menu_show: this.project_config.is_allow_client_door_access, menu_count: 0, id: 'door_access', params: {}},
