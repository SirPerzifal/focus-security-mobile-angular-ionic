...
export class TermsConditionModalComponent implements OnInit {
  ...
  innerHtml: string = `
		...
		<p class="font-bold text-xl">Last updated: February 24, 2025</p>
		<p>This Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your information when You use the Service and tells You about Your privacy rights and how the law protects You.</p>
		<p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the <u><a href="https://www.termsfeed.com/privacy-policy-generator/" target="_blank">Privacy Policy Generator</a></u>.</p>
		...
		<ul>
			...
			<li>
				<p><strong>Application</strong> refers to iFS360, the software program provided by the Company.</p>
			</li>
			<li>
				<p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Focus Security Services Pte Ltd, Vertex Building Tower B, 33 Ubi Ave 3, #08-33, Singapore 408868.</p>
			</li>
			<li>
		...
		<h4>2.1.3. Information Collected while Using the Application</h4>
		...
		<h3>2.5. Delete Your Personal Data</h3>
		...
		<h4>2.6.1. Business Transactions</h4>
		<p>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>
		<h4>2.6.2. Law enforcement</h4>
		<p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
		<h4>2.6.3. Other legal requirements</h4>
		...
		<h3>2.7. Security of Your Personal Data</h3>
		...
		<ul>
			<li>
				<p>By email: enquiry&#64;focussecurity.com.sg</p>
			</li>
			<li>
				<p>By visiting this page on our website: [+65 6842 6898](+65 6842 6898)</p>
			</li>
		</ul>
  `;
